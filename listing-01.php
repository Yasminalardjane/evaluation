<?php
   ...
   // } 
    ...
    // $car = $r->fetchall(PDO::FETCH_ASSOC);
    //   echo "<pre>";
    //   print_r($car);
    // echo "</pre>";
                     ...
                     <div class='car-item gray-bg text-center'>
                        <div class='car-image'>
                           ...
                           <div class='car-overlay-banner'>
                              <ul>
                                 <li><a href='cars/twingo3.html'><i class='fa fa-link'></i></a></li>
                        ...
                        <div class='car-list'>
                           <ul class='list-inline'>
                              <li><i class='fa fa-registered'></i> <?php echo $car["year"]; ?></li>
                              <li><i class='fa fa-cog'></i><?php echo $car["gearbox"]; ?> </li>
                              <li><i class='fa fa-shopping-cart'></i> <?php echo $car["km"]; ?></li>
                           </ul>
                        </div>
                        <div class='car-content'>
                           ...
                           <a href='#'><?php echo $car["car_brand"]; ?></a>
                           <div class='separator'></div>
                           <div class='price'><span class='old-price'><?php echo $car["old_selling_price"]; ?></span><span class='new-price'><?php echo $car["selling_price"]; ?></span></div>
                        </div>
                     </div>
                  </div>
               <?php } ?>
