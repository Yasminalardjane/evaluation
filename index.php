...
// Je récupère les voitures qui sont entrées sur le parc dans les 
// Deux derniers mois
...
<?php 
while($car= $r->fetch(PDO::FETCH_ASSOC)){
   // echo "<pre>";
   // print_r($car);
   // echo "</pre>";
...
?>
    <div class='item'>
      <div class='car-item text-center'>
        <div class='car-image'>
          <img class='img-fluid' src='<?php echo $car["imgs"]; ?>' alt=''>
          <div class='car-overlay-banner'>
            <ul> 
              <li>
                  <a href='descriptif_vehicule.php?id_car=<?php echo $car["id_car"]?><i class='fa fa-link'>
                  </i>
                </a>
              </li><!--<li><a href='#'><i class='fa fa-dashboard'></i></a></li>-->
            </ul>
          </div>
        </div>
        <div class='car-list'>
          <ul class='list-inline'>
            <li>
              <i class='fa fa-registered'> <?php echo $car["year"]; ?></i>
            </li>
            <li>
              <i class='fa fa-cog'>  <?php echo $car["car_brand"]; ?> </i>
            </li>
            <li>
              <i class='fa fa-dashboard'>  <?php echo $car["km"]; ?> </i>
            </li>
          </ul>
        </div>
        <div class='car-content'>
          ...
          <div class='separator'></div>
          <div class='price'>
            <span class='old-price'> <?php echo $car["old_selling_price"]; ?>€</span>
            <span class='new-price'> <?php echo $car["selling_price"]; ?>€</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="blog-content">
            ...
            <a class="button border" href="purchase.php">Envoyer votre demande</a>
           </div>
        </div>
      </div>
    </div>
